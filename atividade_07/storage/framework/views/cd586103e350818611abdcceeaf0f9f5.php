...
<?php if($useSelects): ?>
    <?php $__currentLoopData = $relations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $relation => $plural): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="mb-3">
            ...
            <select class="form-select" id="<?php echo e($relation); ?>_id" name="<?php echo e($relation); ?>_id" required>
                ...
                <?php $__currentLoopData = $$plural; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<div class="mb-3">
    ...
    <?php if(isset($book) && $book->cover_image): ?>
        <div class="mt-2">
            <p>Imagem Atual:</p>
            <img src="<?php echo e(asset('storage/' . $book->cover_image)); ?>" alt="Capa Atual" class="img-thumbnail" width="150">
        </div>
    <?php endif; ?>
</div>
<?php /**PATH /Users/brunorodrigo/Documents/projects-general/curso-IFPE/web2/atividade_07/resources/views/books/partials/form.blade.php ENDPATH**/ ?>